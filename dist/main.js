...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var store_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! store/index */ \"./src/store/index.ts\");\n/* harmony import */ var ui_Mover__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ui/Mover */ \"./src/ui/Mover.ts\");\n/* harmony import */ var ui_Toolbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ui/Toolbar */ \"./src/ui/Toolbar.ts\");\n/* harmony import */ var ui_Canvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ui/Canvas */ \"./src/ui/Canvas.ts\");\n/* harmony import */ var ui_PerfMeter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ui/PerfMeter */ \"./src/ui/PerfMeter.ts\");\n\n\n\n\n\nfunction getDomElem(classSelector) {\n    const element = document.querySelector(`.${classSelector}`);\n    if (!element) {\n        throw new Error(`getDom: unable to find DOM element for ${classSelector} class`);\n    }\n    return element;\n}\nfunction runApplication() {\n    // create store first\n    const store = Object(store_index__WEBPACK_IMPORTED_MODULE_0__[\"initStore\"])();\n    // create the ui\n    Object(ui_Mover__WEBPACK_IMPORTED_MODULE_1__[\"createMover\"])(store)(getDomElem('MapMover'));\n    Object(ui_Toolbar__WEBPACK_IMPORTED_MODULE_2__[\"createToolbar\"])(store)(getDomElem('ControlPanel'));\n    const updatePerfMeter = Object(ui_PerfMeter__WEBPACK_IMPORTED_MODULE_4__[\"createPerfMeter\"])(store)(getDomElem('PerfMeter'));\n    // create canvas\n    const drawCanvas = Object(ui_Canvas__WEBPACK_IMPORTED_MODULE_3__[\"createCanvas\"])(store)(document.getElementById('perfMe'));\n    // render canvas first time\n    drawCanvas();\n    // subscribe to subsequent state updates\n    // note - those are gonna be called on each \"dispatch(message)\" regardless state change\n    store.subscribe(drawCanvas);\n    store.subscribe(updatePerfMeter);\n}\ndocument.addEventListener('DOMContentLoaded', runApplication);\n\n\n//# sourceURL=webpack:///./src/index.ts?");

/***/ }),

/***/ "./src/smile/itemCreator.ts":
/*!**********************************!*\
  !*** ./src/smile/itemCreator.ts ***!
  \**********************************/
